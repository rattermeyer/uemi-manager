...
@Controller
@RequestMapping("${openapi.suSyBusiness.base-path:}")
public class ItemReviewProcessesApiController implements ItemReviewProcessesApi {

    private final NativeWebRequest request;

    @Autowired
    public ItemReviewProcessesApiController(NativeWebRequest request) {
