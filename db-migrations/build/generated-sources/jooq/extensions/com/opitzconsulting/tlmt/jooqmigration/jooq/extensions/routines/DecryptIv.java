...
public class DecryptIv extends AbstractRoutine<byte[]> {
     ...
     */
    public DecryptIv() {
        super("decrypt_iv", Extensions.EXTENSIONS, SQLDataType.BLOB);
