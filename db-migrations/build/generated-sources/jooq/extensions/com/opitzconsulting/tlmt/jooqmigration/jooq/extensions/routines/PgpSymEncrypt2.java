...
public class PgpSymEncrypt2 extends AbstractRoutine<byte[]> {
    ...
    public PgpSymEncrypt2() {
        super("pgp_sym_encrypt", Extensions.EXTENSIONS, SQLDataType.BLOB);
