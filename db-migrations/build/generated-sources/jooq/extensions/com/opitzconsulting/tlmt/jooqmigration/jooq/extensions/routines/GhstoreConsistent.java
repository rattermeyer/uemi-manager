...
public class GhstoreConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>extensions.ghstore_consistent.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>extensions.ghstore_consistent._3</code>.
     */
    public static final Parameter<Short> _3 = Internal.createParameter("_3", SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>extensions.ghstore_consistent._4</code>.
     */
    ...
    public GhstoreConsistent() {
        super("ghstore_consistent", Extensions.EXTENSIONS, SQLDataType.BOOLEAN);
