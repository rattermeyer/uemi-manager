...
public class Dearmor extends AbstractRoutine<byte[]> {
     ...
     */
    public Dearmor() {
        super("dearmor", Extensions.EXTENSIONS, SQLDataType.BLOB);
