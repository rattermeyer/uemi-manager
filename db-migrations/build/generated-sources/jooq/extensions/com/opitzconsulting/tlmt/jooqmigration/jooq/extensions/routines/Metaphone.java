...
public class Metaphone extends AbstractRoutine<String> {
    ...
    /**
     * The parameter <code>extensions.metaphone.RETURN_VALUE</code>.
     */
    public static final Parameter<String> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>extensions.metaphone._1</code>.
     */
    public static final Parameter<String> _1 = Internal.createParameter("_1", SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>extensions.metaphone._2</code>.
     */
     ...
     */
    public Metaphone() {
        super("metaphone", Extensions.EXTENSIONS, SQLDataType.CLOB);
