...
public class PgpPubEncrypt2 extends AbstractRoutine<byte[]> {
    ...
    public PgpPubEncrypt2() {
        super("pgp_pub_encrypt", Extensions.EXTENSIONS, SQLDataType.BLOB);
