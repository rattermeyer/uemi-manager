...
public class PgpSymDecrypt2 extends AbstractRoutine<String> {
    ...
    /**
     * The parameter <code>extensions.pgp_sym_decrypt.RETURN_VALUE</code>.
     */
    public static final Parameter<String> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>extensions.pgp_sym_decrypt._1</code>.
     */
    public static final Parameter<byte[]> _1 = Internal.createParameter("_1", SQLDataType.BLOB, false, true);

    /**
     * The parameter <code>extensions.pgp_sym_decrypt._2</code>.
     */
    public static final Parameter<String> _2 = Internal.createParameter("_2", SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>extensions.pgp_sym_decrypt._3</code>.
     */
    ...
    public PgpSymDecrypt2() {
        super("pgp_sym_decrypt", Extensions.EXTENSIONS, SQLDataType.CLOB);
