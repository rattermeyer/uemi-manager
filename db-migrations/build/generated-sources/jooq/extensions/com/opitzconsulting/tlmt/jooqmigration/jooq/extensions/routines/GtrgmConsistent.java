...
public class GtrgmConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>extensions.gtrgm_consistent.RETURN_VALUE</code>.
     */
    ...
    public GtrgmConsistent() {
        super("gtrgm_consistent", Extensions.EXTENSIONS, SQLDataType.BOOLEAN);
