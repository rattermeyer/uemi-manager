...
public class GinConsistentHstore extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>extensions.gin_consistent_hstore.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>extensions.gin_consistent_hstore._2</code>.
     */
     ...
     */
    @Deprecated
    public static final Parameter<Object> _3 = Internal.createParameter("_3", DefaultDataType.getDefaultDataType("\"extensions\".\"hstore\""), false, true);

    /**
     * The parameter <code>extensions.gin_consistent_hstore._4</code>.
     */
    ...
    public GinConsistentHstore() {
        super("gin_consistent_hstore", Extensions.EXTENSIONS, SQLDataType.BOOLEAN);
