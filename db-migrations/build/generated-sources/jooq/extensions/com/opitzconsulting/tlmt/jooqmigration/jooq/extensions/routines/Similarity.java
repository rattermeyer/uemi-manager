...
public class Similarity extends AbstractRoutine<Float> {
     ...
     */
    public Similarity() {
        super("similarity", Extensions.EXTENSIONS, SQLDataType.REAL);
