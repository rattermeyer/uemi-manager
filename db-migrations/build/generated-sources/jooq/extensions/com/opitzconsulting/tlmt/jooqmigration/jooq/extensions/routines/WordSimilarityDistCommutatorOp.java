...
public class WordSimilarityDistCommutatorOp extends AbstractRoutine<Float> {
    ...
    public WordSimilarityDistCommutatorOp() {
        super("word_similarity_dist_commutator_op", Extensions.EXTENSIONS, SQLDataType.REAL);
