...
public class LevenshteinLessEqual2 extends AbstractRoutine<Integer> {
    ...
    public LevenshteinLessEqual2() {
        super("levenshtein_less_equal", Extensions.EXTENSIONS, SQLDataType.INTEGER);
