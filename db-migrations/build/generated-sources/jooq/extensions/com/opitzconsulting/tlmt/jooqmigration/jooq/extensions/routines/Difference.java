...
public class Difference extends AbstractRoutine<Integer> {
     ...
     */
    public Difference() {
        super("difference", Extensions.EXTENSIONS, SQLDataType.INTEGER);
