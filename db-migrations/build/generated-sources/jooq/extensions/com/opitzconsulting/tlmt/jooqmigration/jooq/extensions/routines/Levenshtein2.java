...
public class Levenshtein2 extends AbstractRoutine<Integer> {
     ...
     */
    public Levenshtein2() {
        super("levenshtein", Extensions.EXTENSIONS, SQLDataType.INTEGER);
