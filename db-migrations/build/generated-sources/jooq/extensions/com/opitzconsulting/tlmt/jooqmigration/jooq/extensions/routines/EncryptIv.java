...
public class EncryptIv extends AbstractRoutine<byte[]> {
     ...
     */
    public EncryptIv() {
        super("encrypt_iv", Extensions.EXTENSIONS, SQLDataType.BLOB);
