...
public class GenSalt2 extends AbstractRoutine<String> {
    ...
    /**
     * The parameter <code>extensions.gen_salt.RETURN_VALUE</code>.
     */
    public static final Parameter<String> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>extensions.gen_salt._1</code>.
     */
    public static final Parameter<String> _1 = Internal.createParameter("_1", SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>extensions.gen_salt._2</code>.
     */
     ...
     */
    public GenSalt2() {
        super("gen_salt", Extensions.EXTENSIONS, SQLDataType.CLOB);
