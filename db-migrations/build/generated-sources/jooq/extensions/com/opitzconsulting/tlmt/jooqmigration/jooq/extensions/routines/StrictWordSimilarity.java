...
public class StrictWordSimilarity extends AbstractRoutine<Float> {
    ...
    public StrictWordSimilarity() {
        super("strict_word_similarity", Extensions.EXTENSIONS, SQLDataType.REAL);
