...
public class Crypt extends AbstractRoutine<String> {
    ...
    /**
     * The parameter <code>extensions.crypt.RETURN_VALUE</code>.
     */
    public static final Parameter<String> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>extensions.crypt._1</code>.
     */
    public static final Parameter<String> _1 = Internal.createParameter("_1", SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>extensions.crypt._2</code>.
     */
     ...
     */
    public Crypt() {
        super("crypt", Extensions.EXTENSIONS, SQLDataType.CLOB);
