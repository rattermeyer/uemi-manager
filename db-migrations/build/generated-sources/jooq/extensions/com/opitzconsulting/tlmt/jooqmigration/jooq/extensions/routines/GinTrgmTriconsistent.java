...
public class GinTrgmTriconsistent extends AbstractRoutine<String> {
    ...
    /**
     * The parameter
     * <code>extensions.gin_trgm_triconsistent.RETURN_VALUE</code>.
     */
    ...
    public GinTrgmTriconsistent() {
        super("gin_trgm_triconsistent", Extensions.EXTENSIONS, SQLDataType.CHAR);
