...
public class GinTrgmConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>extensions.gin_trgm_consistent.RETURN_VALUE</code>.
     */
    ...
    public GinTrgmConsistent() {
        super("gin_trgm_consistent", Extensions.EXTENSIONS, SQLDataType.BOOLEAN);
