...
public class Decrypt extends AbstractRoutine<byte[]> {
     ...
     */
    public Decrypt() {
        super("decrypt", Extensions.EXTENSIONS, SQLDataType.BLOB);
