...
public class Encrypt extends AbstractRoutine<byte[]> {
     ...
     */
    public Encrypt() {
        super("encrypt", Extensions.EXTENSIONS, SQLDataType.BLOB);
