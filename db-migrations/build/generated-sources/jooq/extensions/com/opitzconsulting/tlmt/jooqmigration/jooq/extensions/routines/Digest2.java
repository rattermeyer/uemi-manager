...
public class Digest2 extends AbstractRoutine<byte[]> {
     ...
     */
    public Digest2() {
        super("digest", Extensions.EXTENSIONS, SQLDataType.BLOB);
