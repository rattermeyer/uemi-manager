...
public class GtrgmDistance extends AbstractRoutine<Double> {
    ...
    /**
     * The parameter <code>extensions.gtrgm_distance.RETURN_VALUE</code>.
     */
    ...
    public GtrgmDistance() {
        super("gtrgm_distance", Extensions.EXTENSIONS, SQLDataType.DOUBLE);
